...
<head>
    ...
    <title>Profil Dosen - {{ Auth::user()->name ?? Auth::user()->username }}</title>
...
<body class="text-gray-800">
    ...
    <main class="max-w-lg mx-auto px-3 py-8 mt-20">
        ...
        <div class="info-card text-center">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mt-4">{{ Auth::user()->name ?? 'Nama Dosen' }}</h1>
            ...
            <p class="inline-block bg-blue-100 text-blue-700 text-xs font-semibold px-3 py-1 rounded-full mt-2">
                <i class="fas fa-user-shield mr-1"></i>{{ Str::ucfirst(Auth::user()->role->name ?? 'Dosen') }}
            </p>
            ...
            <div class="mt-10 flex justify-center">
                <a href="{{ route('dosen.profile.edit3') }}" 
