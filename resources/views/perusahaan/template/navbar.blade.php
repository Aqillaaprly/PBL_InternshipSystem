    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <nav class="hidden md:flex space-x-6 font-medium text-gray-700">
                ...
                <a href="{{ route('perusahaan.pendaftar') }}" class="hover:text-blue-600 border-b-s2 border-transparent hover:border-blue-600 transition {{ request()->routeIs('perusahaan.pendaftar') ? 'border-blue-600 text-blue-600' : '' }}">Total Pendaftaran</a>
