     ...
     <div class="flex flex-col min-h-screen">
        <main class="p-6 max-w-7xl mx-auto w-full mt-16"> {{-- Tambahkan margin top jika navbar fixed --}}
            ...
            <div class="text-center mb-10">
                {{-- Menampilkan nama pengguna yang login (perusahaan) --}}
                <h1 class="text-3xl font-bold text-blue-900">Selamat Datang, {{ Auth::user()->username ?? 'Perusahaan' }}!</h1>
        ...
        {{-- Statistik --}}
                    ...
                    <a href="{{ route('perusahaan.lowongan.index') }}" class="cursor-pointer block">
                ...
                {{-- Asumsi ada route bernama 'perusahaan.applicants.index' atau sesuaikan --}}
