...
<head>
    ...
    <title>Edit Profil Admin - {{ Auth::user()->name ?? Auth::user()->username }}</title>
        ...
        <div class="form-card">
            ...
            <form method="POST" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="mt-10 flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-3">
                    <a href="{{ route('admin.profile') }}" class="action-button cancel-button mt-3 sm:mt-0 w-full sm:w-auto">
                        Batal
                    </a>
