        ...
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center">
             ...
             <nav class="hidden md:flex space-x-6 font-medium text-gray-700">
                 ...
                 <a href="{{ route('admin.aktivitas-absensi.index') }}" class="hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition {{ request()->routeIs('admin.aktivitas-absensi.index') || request()->is('admin/aktivitas-absensi*') ? 'border-blue-600 text-blue-600' : '' }}">Aktivitas Mahasiswa Magang</a>
            </nav>
