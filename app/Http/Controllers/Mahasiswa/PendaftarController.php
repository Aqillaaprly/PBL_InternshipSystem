...
{
    // ===== PERUBAHAN 1: UBAH 'nullable' MENJADI 'required' UNTUK PORTOFOLIO =====
    $validatedData = $request->validate([
        'lowongan_id' => 'required|exists:lowongans,id',
        'surat_lamaran' => 'required|file|mimes:pdf,doc,docx|max:5120',
        'cv' => 'required|file|mimes:pdf,doc,docx|max:5120',
        'riwayat_hidup' => 'required|file|mimes:pdf,doc,docx|max:5120',
        'portofolio' => 'required|file|mimes:pdf,doc,docx|max:5120', // Diubah dari nullable
    ...
    try {
        ...
        // ===== PERUBAHAN 2: UBAH 'required' => false MENJADI true UNTUK PORTOFOLIO =====
        $documentConfig = [
            'surat_lamaran' => [
                'name' => 'Surat Lamaran',
                'required' => true,
            ...
            'portofolio' => [
                'name' => 'Portofolio',
                'required' => true, // Diubah dari false
                'type' => 'document'
            ],
            'khs_transkrip' => [
