...
class LowonganController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('perusahaan.lowongan.create', compact('companies')); // Buat view ini: resources/views/perusahaan/lowongan/create.blade.php
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('perusahaan.lowongan.index')->with('success', 'Lowongan berhasil ditambahkan.');
    }
    ...
    {
        return view('perusahaan.lowongan.show', compact('lowongan')); // Buat view ini: resources/views/perusahaan/lowongan/show.blade.php
    }
    ...
    public function edit(Lowongan $lowongan)
    {
        ...
        return view('perusahaan.lowongan.edit', compact('lowongan', 'companies')); // Buat view ini: resources/views/perusahaan/lowongan/edit.blade.php
    }
    ...
    public function update(Request $request, Lowongan $lowongan)
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('perusahaan.lowongan.edit', $lowongan->id)
                ->withErrors($validator)
                ->withInput();
        }
